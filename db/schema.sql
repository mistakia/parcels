...
DROP TABLE
  IF EXISTS `plant_hardiness_zones`;
...
DROP TABLE
  IF EXISTS `broadband_availability`;
...
DROP TABLE
  IF EXISTS `parcels_geometry_extra`;

CREATE TABLE
  `parcels_geometry_extra` (
